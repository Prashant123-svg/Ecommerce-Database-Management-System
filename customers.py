...
class Customers:
   ...
   def create_table():
      cur=con.cursor()
      cur.execute("""CREATE TABLE IF NOT EXISTS Customers(id SERIAL PRIMARY KEY,name VARCHAR(100) NOT NULL, contact VARCHAR(15) NOT NULL)""")
      con.commit()
      cur.close()
   @staticmethod   
        ...
        if choice == '1':
          ...
          if customers:
            ...
            for cust in customers:
              print(f"ID: {cust[0]}, Name: {cust[1]}, Contact: {cust[2]}")
          else: 
